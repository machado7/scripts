...
rows[0].innerHTML += 
  "<th>Include village?</th><th>Select/Deselect All<br><input type='checkbox' id='selectAllBox' onClick='javascript: selectAll(); void(0)'></input></th><th>Invert list<br><input type='checkbox' id='invertListBox' onClick='javascript: invertAll(); void(0)'></input></th>";
...
/*Text Match Table*/
mainTable.innerHTML = "<br><table><tr><th>Text Match</th><td><input type='text' id='textMatchBox' size='17' value='common text to match'/></td></tr><tr><th></th><td><input type='button' value='Perform Text Match' onClick='javascript: byText(); void(0);'></input></td></tr></table><br>" + mainTable.innerHTML;
